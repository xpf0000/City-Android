...
public class Documents extends FragmentActivity implements OnClickListener{
    ...
    private ImageView iv03,mettingback;
    ...
    private void initView() {
        ...
        PubDocum chart = new PubDocum();
        MyDocu friend = new MyDocu();
        UpLoad contact = new UpLoad();
        lists.add(chart);
        lists.add(friend);
        lists.add(contact);

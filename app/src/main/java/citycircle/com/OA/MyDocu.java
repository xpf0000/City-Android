...
public class MyDocu extends Fragment {
    View view, footview;
    ListView doculist;
    String url, urlstr,delurl,delstr;
    String username, uid;
    ...
    private void intview() {
        ...
        myPopwindows.setMyPopwindowswListener(new MyPopwindows.MyPopwindowsListener() {
            ...
            public void onRefresh() {
                ...
                String fid = mFileInfoList.get(positions).getDocuid();
                delurl = GlobalVariables.imgurl + "Files.delUserList&uid=" + uid + "&username=" + username + "fid=" + fid;
            }
        });
    ...
    private void getdoulist(final int type) {
        new Thread() {
            @Override
            public void run() {
                super.run();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    JSONObject jsonObject=JSON.parseObject(delstr);
    ...
    public void setDoculist() {
        ...
        adapter = new DocumentAdapter(getActivity(), mFileInfoList,1,handler);

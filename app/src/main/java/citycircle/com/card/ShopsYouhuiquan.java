...
public class ShopsYouhuiquan extends BaseActivity {
    ...
    private void getData() {
        ...
        XNetUtil.Handle(APPService.jifenGetYHQList(id,uid, page, 20), new XNetUtil.OnHttpResult<List<YouhuiquanModel>>() {
            @Override

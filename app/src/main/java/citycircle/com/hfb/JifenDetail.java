...
public class JifenDetail extends BaseActivity {
    ...
    protected void setupUi() {
        ...
        list = (PullToRefreshListView) findViewById(R.id.jifendetail_list);

        adapter = new JifenDetailAdapter();
    ...
    private void getData() {
        ...
        XNetUtil.Handle(APPService.jifenGethfblist(uid,uname, page, 20), new XNetUtil.OnHttpResult<List<HFBModel>>() {
            @Override
     ...
     */
    class JifenDetailAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            JifenDetail.ListItemView listItemView;
            ...
            if (convertView == null) {
                ...
                listItemView = new JifenDetail.ListItemView();
                ...
                listItemView = (JifenDetail.ListItemView) convertView.getTag();
            }

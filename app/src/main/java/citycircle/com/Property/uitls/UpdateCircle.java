...
public class UpdateCircle {
    public String uploadFile(String Url,String category_id,String username,String content,String location,String xiaoquid) {
        ...
        try {
            ...
            sb.append(BOUNDARY);
            sb.append(LINEND);
            sb.append("Content-Disposition: form-data; name=\"" + "xiaoquid" + "\""
                    + LINEND);
            sb.append(LINEND);
            sb.append(xiaoquid);
            sb.append(LINEND);

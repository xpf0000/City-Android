...
public class MyReply extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        url = GlobalVariables.urlstr + "Quan.getUserComment&uid=" + uid + "&page=" + page;
        intview();
        setlist();
        getnews(0);
        return view;
    ...
    public void intview() {
        ...
        myPopwindows.setMyPopwindowswListener(new MyPopwindows.MyPopwindowsListener() {
            ...
            public void onRefresh() {
                String id = array.get(positions).get("cid");
    ...
    public void getArray(String str) {
        ...
        if (a == 0) {
            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                ...
                hashMap.put("cid", jsonObject2.getString("cid") == null ? "" : jsonObject2.getString("cid"));

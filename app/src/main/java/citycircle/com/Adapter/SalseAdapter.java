...
public class SalseAdapter extends BaseAdapter {
    ...
    public SalseAdapter(ArrayList<HashMap<String, String>> abscure_list,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        getItemView.view = (TextView) convertView.findViewById(R.id.view);
        final String url = abscure_list.get(position).get("path");
        getItemView.content.setText(abscure_list.get(position).get("title"));
        String starttime = dateUtils.getDateToStringsa(Long.parseLong(abscure_list.get(position).get("s_time")));
        String endtime = dateUtils.getDateToStringsa(Long.parseLong(abscure_list.get(position).get("e_time")));
